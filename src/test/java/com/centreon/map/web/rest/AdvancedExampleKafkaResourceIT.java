...
import com.centreon.map.AdvancedExampleApp;
import com.centreon.map.RedisTestContainerExtension;
import com.centreon.map.service.AdvancedExampleKafkaProducer;
import com.centreon.map.service.AdvancedExampleKafkaConsumer;
...
@SpringBootTest(classes = AdvancedExampleApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
@ExtendWith(RedisTestContainerExtension.class)
public class AdvancedExampleKafkaResourceIT {
    ...
    @Autowired
    private AdvancedExampleKafkaProducer producer;

    @Autowired
    private AdvancedExampleKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        AdvancedExampleKafkaResource kafkaResource = new AdvancedExampleKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/advanced-example-kafka/publish?message=test"))
